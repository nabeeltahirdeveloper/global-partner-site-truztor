        ...
        <div className="lg:col-span-8 space-y-12">
          ...
          <section className="space-y-12 pb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="exclusive-card p-10 space-y-6 flex flex-col items-center text-center border-t-4 border-t-[#c5a059]">
                <div className="relative w-40 h-40">
                  <img src="https://img.mauritius-images.com/WEST/cprev/15748331.jpg/save_as_name/mauritius%20images%20-%2015748331%20-%20Smiling%20woman%20in%20bathrobe%20outdoors%20enjoying%20nature%20and%20skin%20care.jpg" className="w-full h-full rounded-full border-4 border-white shadow-xl object-cover grayscale hover:grayscale-0 transition-all duration-700" alt="" />
